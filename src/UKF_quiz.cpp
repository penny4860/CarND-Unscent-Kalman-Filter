...
void test_predict_mean_covariance(void)
{
	  //set state dimension
	  int n_x = 5;
...
void test_predict_sigma_point(void)
{
	  //set state dimension
	  int n_x = 5;
	 ...
	 ******************************************************************************/
	  ...
	  for (int i = 0; i < 2*n_aug+1; i++)
	  {
		  ...
		  {
			  x_pred(0) = px + v/theta_dot * (sin(theta + theta_dot*delta_t) - sin(theta));
			  x_pred(1) = py + v/theta_dot * (-cos(theta + theta_dot*delta_t) + cos(theta));
		  }
		  x_pred(2) = v;
...
void test_augmented_sigma_point_generation(void)
{
	  //set state dimension
	  int n_x = 5;
...
void test_sigma_point_generation(void)
{
	//set state dimension
	int n_x = 5;
	...
	******************************************************************************/
	...
	//print result
	cout << "Xsig = " << std::endl << Xsig << std::endl;
